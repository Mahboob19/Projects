...
public class displaycondidatelist extends javax.swing.JFrame {
    ...
    public ArrayList<User2> userlist2()
    {
        ...
        try{
            ...
            Connection  con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:XE","system","jamesbond");
            ...
            while(rs.next())
            {
            user2=new User2(rs.getString("name"),rs.getString("post"),rs.getString("gender"),rs.getInt("age"),rs.getString("partyname"),rs.getString("state"));
           userlist2.add(user2);
            }
