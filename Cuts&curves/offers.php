...
<body>	
  <div class="navbar navbar-expand-sm navbar-dark bg-dark">
   ...
   <UL class="navbar-nav ml-auto">
    ...
    <li class="nav-item">
      <a href="#" class="nav-link">
              <span class="glyphicon glyphicon-hand-right"></span> <span style="color:white"><strong>Notice : </strong>
  ...
  <div id="heading">Plans</div>
  <div class="row container-fluid" style="padding-top:10px;">
    <div class="col-md-6">
      <img src="images\offer.jpg" class="img-fluid" style="padding-top: 10px;">
    </div> 
    <div class="col-md-6">
      <img src="images\offer1.png" class="img-fluid" style="padding-top: 10px;">
    </div>
  </div>
  <div class="row container-fluid" style="padding-top:10px;">
    <div class="col-md-6">
      <img src="images\offer2.png" class="img-fluid" style="padding-top: 10px;">
    </div> 
    <div class="col-md-6">
      <img src="images\offer3.png" class="img-fluid" style="padding-top: 10px;">
      <span class="glyphicon glyphicon-hand-right" style="color: red;margin-left:30px;"></span>
      <span><strong>For more information call +91-7007970016(V.K Jaiswal)or +91-8115785795</strong></span>
    </div></div>
<div id="footer">Cuts & Curve 2019 &copy; Copy Right Reserved</div>
</body>
</html>