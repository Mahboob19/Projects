<?php
$con = mysqli_connect("localhost","root","","chatterbox") or die("Connection was not established");
		...
		if($content=="No" && strlen($upload_image) >= 1){
			...
			<div class='row'>
				...
				<div class='row'>
					...
					<div class='col-sm-10'>
						<img id='posts-img' src='imagepost/$upload_image' style='height:450px;'>
					</div>
				</div><br>
	...
	$get_user = "select * from users where fullname like '%$search_query%' OR user_name like '%$search_query%'";
	}
	else{
