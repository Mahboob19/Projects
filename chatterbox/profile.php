...
<div class="row">
	...
	<div class="col-sm-2" style="background-color: #e6e6e6; text-align: center; left:0.8%; border-radius: 5px;">
		...
		<center><h4><strong>$first_name</strong></h4></center>
	...
	<div class="col-sm-6">
		...
		<?php
			...
			<div id='own_posts'>
				...
				<a href='single.php?post_id=$post_id' style='padding-left:413px;'><button class='btn btn-success'>View</button></a>
			...
			echo"
				<a href='single.php?post_id=$post_id' style='padding-left:350px;'><button class='btn btn-success'>View</button></a>
				<a href='edit_post.php?post_id=$post_id' style='padding-left:10px;'><button  class='btn btn-info'>Edit</button></a>
				<a href='functions/delete_post.php?post_id=$post_id' style='float:right;'><button class='btn btn-danger'>Delete</button></a>
			</div><br/><br/><br/>
			";
			}
