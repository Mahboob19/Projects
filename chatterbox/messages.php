	...
	<div class="col-sm-3" id='select_user'>
		<?php
			...
			<div class='container-fluid'>
				...
				<img class='img-circle' src='users/$user_image' width='90px' height='80px' title='$user_name' /> <strong> &nbsp$first_name </strong><br><br>
				</a>
			</div>
	...
	<div class="col-sm-6">
		...
		<?php
			if(isset($_POST['send_msg'])){
				...
				}else if(strlen($msg) > 2000){
					echo"<h4 style='color:red;text-align:center;'>Message is Too long! Use only 2000 characters</h4>";
				}
				else{
