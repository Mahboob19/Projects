...
public class displayvoter extends javax.swing.JFrame {
    ...
    public ArrayList<User> userlist()
    {
        ...
        try{
            ...
            while(rs.next())
            {
            user=new User(rs.getString("name"),rs.getString("fname"),rs.getString("gender"),rs.getInt("age"),rs.getString("address"),rs.getString("state"),rs.getString("dob"),rs.getString("addharno"));
           userlist.add(user);
            }
